# Graph Workspace Batch H Pointer Continuation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use the deterministic
> subagent-driven-development controller to implement this plan task-by-task.
>
> This continuation preserves all terminal dispatch-mismatch runs as immutable
> audit evidence and replaces failure-prone inline role-prompt transport with
> persisted file-backed envelopes. Commit `50d0c3bd1502158b19f3ea459cc6cfe5044525d0` is a
> carry-forward candidate produced by an inadmissible child and must receive a
> fresh inspect-only audit and independent task review before later tasks rely on
> it.
...
- The terminal runs at `.superpowers/sdd/2026-08-20-graph-workspace-batch-h-ui-shell-continuation`, `.superpowers/sdd/2026-08-20-graph-workspace-batch-h-ui-successor`, `.superpowers/sdd/2026-08-20-graph-workspace-batch-h-post-task-2-mismatch`, `.superpowers/sdd/2026-08-20-graph-workspace-batch-h-status-lifecycle-recovery`, `.superpowers/sdd/2026-08-20-graph-workspace-batch-h-lifecycle-ui-continuation`, and `.superpowers/sdd/2026-08-20-graph-workspace-batch-h-lifecycle-audit-reissue` are immutable audit history only. Do not reopen, modify, or cite their child reports as approval evidence.
...
Report concrete results and any finding. Do not alter the two source files or create a commit. The following fresh task-reviewer gate independently approves or rejects this exact range.
