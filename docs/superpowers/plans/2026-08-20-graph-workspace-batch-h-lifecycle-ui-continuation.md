# Graph Workspace Batch H Lifecycle and UI Continuation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use the deterministic
> subagent-driven-development controller to implement this plan task-by-task.
>
> This continuation preserves all terminal dispatch-mismatch runs as immutable
> audit evidence. Commit `50d0c3bd1502158b19f3ea459cc6cfe5044525d0` is a
...
**Architecture:** Task 1 audits the exact two-file lifecycle correction without changing source and lets a fresh review gate decide whether it is carried forward. Task 2 builds headless operational dialogs and status controls on the audited immutable status seam. Task 3 wires application actions, menus, icons, translations, and distinct workspace/source-map undo behavior.
...
- The terminal runs at `.superpowers/sdd/2026-08-20-graph-workspace-batch-h-ui-shell-continuation`, `.superpowers/sdd/2026-08-20-graph-workspace-batch-h-ui-successor`, `.superpowers/sdd/2026-08-20-graph-workspace-batch-h-post-task-2-mismatch`, and `.superpowers/sdd/2026-08-20-graph-workspace-batch-h-status-lifecycle-recovery` are immutable audit history only. Do not reopen, modify, or cite their child reports as approval evidence.
