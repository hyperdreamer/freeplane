...
public class AiRequestTimeoutControllerFactory {
    ...
    public AiRequestTimeoutControllerFactory() {
        this(TIMEOUT_EXECUTOR::schedule);
    }

    public AiRequestTimeoutControllerFactory(AiRequestTimeoutController.TimeoutScheduler timeoutScheduler) {
